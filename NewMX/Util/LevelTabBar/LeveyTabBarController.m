...
- (id)initWithViewControllers:(NSArray *)vcs imageArray:(NSArray *)arr
{
	...
	if (self != nil)
	{
		...
		if (iPhone5) {
		_tabBar = [[LeveyTabBar alloc] initWithFrame:CGRectMake(0,568  - kTabBarHeight, 320.0f, 52) buttonImages:arr];
        }
        else
        {
        _tabBar = [[LeveyTabBar alloc] initWithFrame:CGRectMake(0,480 - kTabBarHeight, 320.0f, 52) buttonImages:arr];
        
        }
        if (!iPhone5&&!iOS_7) {
             _tabBar = [[LeveyTabBar alloc] initWithFrame:CGRectMake(0,480 - kTabBarHeight-20, 320.0f, 52) buttonImages:arr];
        }
