...
- (void)viewDidLoad
{
    ...
    if (!iOS_7) {
     ...
     imageview = [[UIImageView alloc] initWithFrame:CGRectMake(0,0, self.view.frame.size.width, self.view.frame.size.height+1)];
    }
    else
    {
      image = [UIImage imageNamed:@"Default~iphone.png"];
     imageview  = [[UIImageView alloc] initWithFrame:CGRectMake(0,0, self.view.frame.size.width, 480)];
    }
    if (iPhone5) {
        image = [UIImage imageNamed:@"Default-568h@2x.png"];
...
-(void)pushSecondController
{
    ...
    nc_indexVC.view.backgroundColor = [UIColor grayColor];
    ...
    nc_productVC.view.backgroundColor = [UIColor grayColor];
    UINavigationController * nc_classVC = [[UINavigationController alloc]initWithRootViewController:classVC];
    nc_classVC.view.backgroundColor = [UIColor grayColor];
    ...
    [self.navigationController pushViewController:leveyTabBarController animTransType:2];
